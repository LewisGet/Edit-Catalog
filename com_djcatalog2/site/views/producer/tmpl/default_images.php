<?php
/**
 * @version $Id: default_images.php 272 2014-05-21 10:25:49Z michal $
 * @package DJ-Catalog2
...
<div class="djc_images pull-right">
	...
	<?php } ?>
	<?php for($i = 0; $i < count($this->item->images); $i++) { ?>
		<a id="djc_lb_<?php echo $i; ?>" rel="djimagebox-djproducer" title="<?php echo $this->item->images[$i]->caption; ?>" href="<?php echo $this->item->images[$i]->fullscreen; ?>" style="display: none;"></a>
	<?php } ?>
</div>